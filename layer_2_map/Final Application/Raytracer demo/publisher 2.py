...
def convertPngToBytes():
    ...
    while not os.path.isfile('data/map/layer 2/mapLayer2_{}.png'.format(counter)):
        print("waiting for file")

    if os.path.isfile('data/map/layer 2/mapLayer2_{}.png'.format(counter)):
        time.sleep(1)
        img = Image.open('data/map/layer 2/mapLayer2_{}.png'.format(counter), mode='r')
        print("sending file ", counter, ".")
