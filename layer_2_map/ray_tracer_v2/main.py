...
# camera data from Object/People Tracking
...
def trace_objects():
    ...
    start_correction, stop_correction = refine_camera_angle(object_image_x, object_image_y, object_image_width, object_image_height)
